    ...
    return (
        <View style={[styles.container, { backgroundColor: colors.background }]}>
            ...
            <View style={styles.header}>
                ...
                <View>
                    <CustomText variant="h1" style={{ fontSize: 24 }}>My Profile</CustomText>
                    <CustomText style={{ color: colors.muted, fontSize: 13, marginTop: 2 }}>Account details and verification</CustomText>
                </View>
            </View>
                ...
                {loading ? (
                    ...
                    <>
                        <View style={[styles.card, styles.avatarCard, { backgroundColor: colors.glass, borderColor: colors.border }]}>
                            ...
                            <View style={{ flex: 1 }}>
                                ...
                                <View style={[styles.roleBadge, { backgroundColor: `${colors.primary}15`, borderColor: `${colors.primary}30` }]}>
                                    ...
                                    <CustomText style={{ color: colors.primary, fontSize: 10, fontWeight: '800', marginLeft: 6, letterSpacing: 0.5 }}>AGENT / STAFF</CustomText>
                                </View>
                            </View>
                        </View>
                        ...
                        <View style={[styles.card, { backgroundColor: colors.glass, borderColor: colors.border }]}>
                            <CustomText style={styles.sectionLabel}>ACCOUNT INFORMATION</CustomText>
                            ...
                            <View style={styles.accountRow}>
                                ...
                                <View style={{ marginLeft: 16 }}>
                                    <CustomText style={styles.infoLabel}>EMAIL ADDRESS</CustomText>
                            ...
                            <View style={styles.accountRow}>
                                ...
                                <View style={{ marginLeft: 16 }}>
                                    <CustomText style={styles.infoLabel}>ROLE</CustomText>
                        ...
                        {/* Assigned location */}
                        <View style={[styles.card, { backgroundColor: colors.glass, borderColor: colors.border }]}>
                            <CustomText style={styles.sectionLabel}>ASSIGNED PICKUP LOCATION</CustomText>
                            {profile?.pickupLocation ? (
                                <View style={{ flexDirection: 'row', alignItems: 'flex-start' }}>
                                    ...
                                    <View style={{ marginLeft: 16, flex: 1 }}>
                                        ...
                                        <CustomText style={{ color: colors.muted, fontSize: 12, marginTop: 8 }}>
                                            Hours: <CustomText style={{ color: colors.foreground, fontWeight: '600' }}>{profile.pickupLocation.openTime} – {profile.pickupLocation.closeTime}</CustomText>
                                        </CustomText>
                                    </View>
                                </View>
                            ) : (
                                <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                                    ...
                                    <CustomText style={{ color: colors.muted, fontSize: 13, marginLeft: 12 }}>No pickup location assigned.</CustomText>
                                </View>
                            )}
                        </View>
                        ...
                        <View style={[styles.card, { backgroundColor: colors.glass, borderColor: colors.border, marginBottom: 40 }]}>
                            <View style={styles.sectionHeaderRow}>
                                ...
                                <View style={{ marginLeft: 16 }}>
                                    <CustomText variant="h3" style={{ fontSize: 18 }}>Agent Verification</CustomText>
                                    <CustomText style={{ color: colors.muted, fontSize: 11 }}>Submit documents for verification</CustomText>
                                </View>
                            </View>
                            ...
                            {success ? (
                                <View style={[styles.statusBanner, { backgroundColor: `${colors.primary}10`, borderColor: `${colors.primary}20` }]}>
                                    ...
                                    <View style={{ marginLeft: 16, flex: 1 }}>
                                        <CustomText style={{ fontWeight: '800', color: colors.foreground }}>Documents Submitted!</CustomText>
                                        <CustomText style={{ color: colors.muted, fontSize: 11, marginTop: 2 }}>Review process usually takes 24–48 hours.</CustomText>
                                    </View>
                                </View>
                            ) : (
                                <>
                                    <View style={[styles.benefitBox, { backgroundColor: `${colors.primary}05`, borderColor: `${colors.primary}10` }]}>
                                        <CustomText style={styles.benefitTitle}>
                                            <Star size={11} color={colors.primary} /> WHY GET VERIFIED?
                                        </CustomText>
                                        <View style={styles.benefitGrid}>
                                            {["Trust badge on profile", "Priority assignments", "Higher order volume", "Buyer & seller ratings"].map((b, i) => (
                                    ...
                                    <View style={{ marginTop: 24 }}>
                                        <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 12 }}>
                                            <CustomText style={styles.sectionLabelSmall}>UPLOAD DOCUMENTS</CustomText>
                                            <CustomText style={{ fontSize: 10, color: colors.muted }}>Up to 3 files</CustomText>
                                        </View>
                                            ...
                                            {selectedDocs.map((doc, i) => (
                                                <View key={i} style={[styles.uploadItem, { backgroundColor: 'rgba(255,255,255,0.03)', borderColor: colors.border }]}>
                                                    ...
                                                    <View style={{ flex: 1, marginLeft: 12 }}>
                                                        ...
                                                        <CustomText style={{ fontSize: 10, color: colors.muted }}>{doc.url ? 'Ready' : 'Pending upload'}</CustomText>
                                                    </View>
                                                    {doc.url ? (
                                        ...
                                        {selectedDocs.length < 3 && (
                                            ...
                                            >
                                                ...
                                                <CustomText style={{ color: colors.muted, marginTop: 8, fontWeight: '800', fontSize: 13 }}>Click to upload document</CustomText>
                                                <CustomText style={{ color: colors.muted, fontSize: 10, marginTop: 4, opacity: 0.6 }}>JPG, PNG · Max 10MB</CustomText>
                                            </TouchableOpacity>
                                        )}
                                        ...
                                        >
                                            {submitting ? (
                                                ...
                                                <>
                                                    ...
                                                    <CustomText style={{ color: '#FFF', fontWeight: '800', marginLeft: 8 }}>Submit for Verification</CustomText>
                                                </>
                                            )}
                                        </TouchableOpacity>
                                    </View>
